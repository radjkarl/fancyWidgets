...
from fancywidgets import FwTextEditor
...
class FwTextEditorPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):

    """FwTextEditorPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin)
    ...
    def __init__(self, parent=None):
        ...
        super(FwTextEditorPlugin, self).__init__(parent)
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = FwTextEditorTaskMenuFactory(manager)
            manager.registerExtensions(
                self.factory, "QPyDesignerTaskMenuExtension"
                )
    ...
    def domXml(self):
        return '<widget class="FwTextEditor" name="FwTextEditor" />\n'
...
class FwTextEditorTaskMenuFactory(QtDesigner.QExtensionFactory):

    """FwTextEditorTaskMenuFactory(QtDesigner.QExtensionFactory)
    ...
    def createExtension(self, obj, iid, parent):
        ...
        if iid != QPyDesignerTaskMenuExtension":
            return None
        ...
        # modified.
        if isinstance(obj, FwTextEditor):
            return FwTextEditorTaskMenu(obj, parent)

        return None


class FwTextEditorTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):

    """FwTextEditorTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension)
    ...
    def __init__(self, textEdit, parent):
        ...
        super(FwTextEditorTaskMenu, self).__init__(parent)
    ...
    def editText(self):
        ...
        FwTextEditorDialog(self.textEdit).exec_()


class FwTextEditorDialog(QtGui.QDialog):

    """FwTextEditorDialog(QtGui.QDialog)
    ...
    def __init__(self, editor, parent=None):
        ...
        super(FwTextEditorDialog, self).__init__(parent)

        self.editor = editor
        self.textEdit = FwTextEditor()
