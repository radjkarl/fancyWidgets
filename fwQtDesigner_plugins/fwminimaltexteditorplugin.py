...
#from analogclock import FwMinimalTextEditor
...
class FwMinimalTextEditorPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def createWidget(self, parent):
        return FwMinimalTextEditor(parent)

    # This method returns the name of the custom widget class that is provided
    # by this plugin.
    def name(self):
        return "FwMinimalTextEditor"
    ...
    def domXml(self):
        return '<widget class="FwMinimalTextEditor" name="TextEditor">\n' \
