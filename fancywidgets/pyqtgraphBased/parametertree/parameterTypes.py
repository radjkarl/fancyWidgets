    ...
    **Registered Types:**
    ...
    def updateDefaultBtn(self):
        ...
        self.defaultBtn.setEnabled(
            not self.param.valueIsDefault() and self.param.writable())
...
class ListParameterItem(WidgetParameterItem):
    ...
    def limitsChanged(self, param, limits):
        ...
        if len(limits) == 0:
            # Can never have an empty list--there is always at least a singhe
            # blank item.
            limits = ['']
...
class ListParameter(Parameter):
    ...
    @staticmethod
    def mapping(limits):
        # Return forward and reverse mapping objects given a limit
        # specification
